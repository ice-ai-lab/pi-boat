...
| **F3 文件域** | client：files/file-index 端点 + files/ 模块；ui：files/ 全册（FileTree/FileTabs/FileViewer/CodeViewer/ImagePreview/DiffView）；`@` 提及（file-fuzzy）；上传 | 右栏多标签查看器、侧栏文件树、代码高亮、diff、图片 | 1.5 周 |
